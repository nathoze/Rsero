...
```{r figsize, warning=FALSE, message = FALSE}
...
print(C_3)
```
The DIC is significantly lower for model 10 than for model 6 and 9. This indicates that model 10 (outbreak model with imperfect sensitivity) is more adequate at fitting the data.
