...
stan_diag(Fit_2$fit,info = c("sample")) # shows diagnostic (loglikelihood, acceptance rate,etc)
stan_rhat(Fit_2$fit) # show the Rhat statistic
stan_ess(Fit_2$fit) # show the ratio of effective sample size over total sample size
``` 
