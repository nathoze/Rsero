...
chikv_vietnam = Rsero::SeroData(age_at_sampling = round(as.numeric(sero.data$age)), 
                                ...
                                location = as.character(sero.data$Loc))
...
In the case of the `"outbreak"` and the `"constantoutbreak"` models, when `K>1` each outbreak can be defined by a specific set of prior distributions.
