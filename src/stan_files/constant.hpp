...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 1;
        annual_foi = stan::math::lb_constrain(annual_foi, 0.00001, lp__);
      } else {
        current_statement__ = 1;
        annual_foi = stan::math::lb_constrain(annual_foi, 0.00001);
      }
      ...
      for (int j = 1; j <= A; ++j) {
        ...
        assign(lambda, cons_list(index_uni(j), nil_index_list()), annual_foi,
...
(void) function__;  // suppress unused var warning
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 1;
      annual_foi_free__ = stan::math::lb_free(annual_foi, 0.00001);
      double rho;
      rho = std::numeric_limits<double>::quiet_NaN();
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"annual_foi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"Flambda2\",\"type\":{\"name\":\"array\",\"length\":" << maxNcategory << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategoryclass << ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"parameters\"},{\"name\":\"x\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"P1\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"array\",\"length\":" << NAgeGroups << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"P\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"array\",\"length\":" << NAgeGroups << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"Flambda\",\"type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"Likelihood\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]";
    return s__.str();
