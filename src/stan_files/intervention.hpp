...
public:
  ...
  inline std::string model_name() const final { return "model_intervention"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_intervention(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_intervention_namespace::model_intervention";
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        current_statement__ = 148;
        current_statement__ = 148;
        check_greater_or_equal(function__, "priorT1[sym1__]",
                               priorT1[(sym1__ - 1)], 0);}
      ...
      validate_non_negative_index("annual_foi", "K", K);
      ...
      validate_non_negative_index("Time", "K", K);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_intervention_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      annual_foi = std::vector<local_scalar_t__>(K, DUMMY_VAR__);
      
      current_statement__ = 2;
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        current_statement__ = 2;
        assign(annual_foi, cons_list(index_uni(sym1__), nil_index_list()),
          in__.scalar(), "assigning variable annual_foi");}
      current_statement__ = 2;
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        current_statement__ = 2;
        if (jacobian__) {
          current_statement__ = 2;
          assign(annual_foi, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(annual_foi[(sym1__ - 1)], 0.00001, lp__),
            "assigning variable annual_foi");
        } else {
          current_statement__ = 2;
          assign(annual_foi, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(annual_foi[(sym1__ - 1)], 0.00001),
            "assigning variable annual_foi");
        }}
      ...
      Time = std::vector<local_scalar_t__>(K, DUMMY_VAR__);
      ...
      assign(Time, cons_list(index_uni(1), nil_index_list()), 1,
      ...
      if (logical_eq(K, 1)) {
        ...
        for (int j = 1; j <= A; ++j) {
          ...
          assign(lambda, cons_list(index_uni(j), nil_index_list()),
            annual_foi[(K - 1)], "assigning variable lambda");}
      } else {
        current_statement__ = 17;
        for (int i = 2; i <= K; ++i) {
          current_statement__ = 15;
          assign(Time, cons_list(index_uni(i), nil_index_list()),
            (Time[((i - 1) - 1)] + T[(i - 1)]), "assigning variable Time");}
        current_statement__ = 27;
        for (int j = 1; j <= A; ++j) {
          current_statement__ = 25;
          for (int i = 1; i <= (K - 1); ++i) {
            current_statement__ = 20;
            if ((primitive_value(logical_gte(j, Time[(i - 1)])) &&
                primitive_value(logical_lt(j, Time[((i + 1) - 1)])))) {
              current_statement__ = 18;
              assign(lambda, cons_list(index_uni(j), nil_index_list()),
                annual_foi[(i - 1)], "assigning variable lambda");
            } 
            current_statement__ = 23;
            if (logical_gte(j, Time[(K - 1)])) {
                            ...
                            Likelihood[(sym1__ - 1)], 1);}
      {
        ...
        for (int i = 1; i <= K; ++i) {
          ...
          lp_accum__.add(
            uniform_lpdf<propto__>(annual_foi[(i - 1)], priorC1, priorC2));}
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_intervention_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      annual_foi = std::vector<double>(K, std::numeric_limits<double>::quiet_NaN());
      ...
      Time = std::vector<double>(K, std::numeric_limits<double>::quiet_NaN());
      ...
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(annual_foi[(sym1__ - 1)]);}
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 2;
      assign(annual_foi, nil_index_list(), context__.vals_r("annual_foi"),
        "assigning variable annual_foi");
      std::vector<double> annual_foi_free__;
      annual_foi_free__ = std::vector<double>(K, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 2;
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        current_statement__ = 2;
        assign(annual_foi_free__,
          cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::lb_free(annual_foi[(sym1__ - 1)], 0.00001),
          "assigning variable annual_foi_free__");}
      double rho;
      rho = std::numeric_limits<double>::quiet_NaN();
      ...
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(T[(sym1__ - 1)]);}
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(annual_foi_free__[(sym1__ - 1)]);}
  ...
  inline void constrained_param_names(
    ...
    for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
      {
        param_names__.emplace_back(std::string() + "annual_foi" + '.' + std::to_string(sym1__));
      }}
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"T\",\"type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"annual_foi\",\"type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"Flambda2\",\"type\":{\"name\":\"array\",\"length\":" << maxNcategory << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategoryclass << ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"parameters\"},{\"name\":\"x\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"Time\",\"type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"P1\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"array\",\"length\":" << NAgeGroups << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"P\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"array\",\"length\":" << NAgeGroups << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"Flambda\",\"type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"Likelihood\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]";
    return s__.str();
