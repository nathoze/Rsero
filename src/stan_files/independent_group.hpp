...
public:
  ...
  model_independent_group(stan::io::var_context& context__, unsigned int
    ...
    try {
      ...
      stan::math::validate_non_negative_index("logitlambda", "NGroups",
        NGroups);
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      logitlambda = in__.template read_constrain_lb<
      ...
      for (int j = 1; j <= A; ++j) {
        ...
        stan::model::assign(lambda,
          stan::model::rvalue(logitlambda, "logitlambda",
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      current_statement__ = 1;
      context__.validate_dims("parameter initialization", "logitlambda",
      ...
      std::vector<local_scalar_t__> logitlambda =
        std::vector<local_scalar_t__>(NGroups, DUMMY_VAR__);
      current_statement__ = 1;
      logitlambda = context__.vals_r("logitlambda");
      out__.write_free_lb(0, logitlambda);
      local_scalar_t__ rho = DUMMY_VAR__;
      current_statement__ = 2;
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"logitlambda", "rho", "Flambda2"};
    if (emit_transformed_parameters__) {
      std::vector<std::string>
        temp{"x", "L", "lambda", "P1", "P", "Flambda", "Likelihood", "c"};
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    for (int sym1__ = 1; sym1__ <= NGroups; ++sym1__) {
      param_names__.emplace_back(std::string() + "logitlambda" + '.' +
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"logitlambda\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(NGroups) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"Flambda2\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(maxNcategory) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(Ncategoryclass) + ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"parameters\"},{\"name\":\"x\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(A) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(A) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"P1\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(A) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(NAgeGroups) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(Ncategory) + ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"P\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(A) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(NAgeGroups) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(Ncategory) + ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"Flambda\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(Ncategory) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"Likelihood\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_transformed = emit_transformed_parameters * ((((((((A +
      1) + A) + ((A * NAgeGroups) * Ncategory)) + ((A * NAgeGroups) *
