...
public:
  ...
  inline std::string model_name() const final { return "model_constantoutbreak"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_constantoutbreak(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_constantoutbreak_namespace::model_constantoutbreak";
    ...
    try {
      ...
      current_statement__ = 151;
      current_statement__ = 151;
      check_greater_or_equal(function__, "priorC1", priorC1, 0);
      ...
      current_statement__ = 152;
      current_statement__ = 152;
      check_greater_or_equal(function__, "priorC2", priorC2, 0);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_constantoutbreak_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      local_scalar_t__ annual_foi;
      annual_foi = DUMMY_VAR__;
      
      current_statement__ = 6;
      annual_foi = in__.scalar();
      current_statement__ = 6;
      if (jacobian__) {
        current_statement__ = 6;
        annual_foi = stan::math::lb_constrain(annual_foi, 0, lp__);
      } else {
        current_statement__ = 6;
        annual_foi = stan::math::lb_constrain(annual_foi, 0);
      }
                            ...
                            Likelihood[(sym1__ - 1)], 1);}
      {
        ...
        lp_accum__.add(uniform_lpdf<propto__>(annual_foi, priorC1, priorC2));
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_constantoutbreak_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= maxNcategory; ++sym1__) {
        ...
        for (int sym2__ = 1; sym2__ <= Ncategoryclass; ++sym2__) {
          ...
          assign(Flambda2,
            ...
            "assigning variable Flambda2");}}
      double annual_foi;
      annual_foi = std::numeric_limits<double>::quiet_NaN();
      ...
      vars__.emplace_back(annual_foi);
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      double annual_foi_free__;
      annual_foi_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 6;
      annual_foi_free__ = stan::math::lb_free(annual_foi, 0);
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(T[(sym1__ - 1)]);}
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
      ...
      vars__.emplace_back(annual_foi_free__);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__.emplace_back("annual_foi");
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"T\",\"type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"Flambda2\",\"type\":{\"name\":\"array\",\"length\":" << maxNcategory << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategoryclass << ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"parameters\"},{\"name\":\"annual_foi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"x\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"S\",\"type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"P1\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"array\",\"length\":" << NAgeGroups << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"P\",\"type\":{\"name\":\"array\",\"length\":" << A << ",\"element_type\":{\"name\":\"array\",\"length\":" << NAgeGroups << ",\"element_type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}}}},\"block\":\"transformed_parameters\"},{\"name\":\"Flambda\",\"type\":{\"name\":\"array\",\"length\":" << Ncategory << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"Likelihood\",\"type\":{\"name\":\"array\",\"length\":" << N << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"c\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]";
    return s__.str();
