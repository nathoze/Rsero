...
##' 
##' @param prioralpha1 First parameter of the prior distribution of the parameter alpha, used as the intensity of the force of infection in the outbreak models. If a normal distribution is chosen, it corresponds to the mean parameter. If a uniform distribution is chosen, it corresponds to the minimal value. If an exponential distribution is chosen, it is its parameter. Default = 0.2.
##' 
##' @param prioralpha2 Second parameter of the prior distribution of the parameter alpha, used as the intensity of the force of infection in the outbreak models. If a normal distribution is chosen, it corresponds to the sd parameter. If a uniform distribution is chosen, it corresponds to the maximal value. Default = 1.
##' 
##' @param priorT1 First parameter for the prior distribution for the T parameter. The time of the outbreak is defined as the number of years before the survey (outbreak and constant outbreak models). It is the time interval for the change of FOI in the piecewise constant model.If a normal distribution is chosen, it corresponds to the mean parameter. If a uniform distribution is chosen, it corresponds to the minimal value. If an exponential distribution is chosen, it is its parameter. Default = 50.
##' 
##' @param priorT2 Second parameter for the prior distribution for the T parameter. If a normal distribution is chosen, it corresponds to the sd parameter. If a uniform distribution is chosen, it corresponds to the maximal value. Default = 20.
##' 
##' @param priorC1  First parameter of the prior distribution for the constant force of infection, used in the constant and piecewise constant models. If a normal distribution is chosen, it corresponds to the mean parameter. If a uniform distribution is chosen, it corresponds to the minimal value. If an exponential distribution is chosen, it is its parameter. Default = 0.01.
##' 
##' @param priorC2  Second parameter of the prior distribution for the constant force of infection, used in the constant and piecewise constant models. If a normal distribution is chosen, it corresponds to the sd parameter. If a uniform distribution is chosen, it corresponds to the maximal value. Default = 1.
##' 
##' @param priorY1 First parameter of the prior distribution for the annual hazard of infection, used in the independent models. If a normal distribution is chosen, it corresponds to the mean parameter. If a uniform distribution is chosen, it corresponds to the minimal value. If an exponential distribution is chosen, it is its parameter. Default = 0.01.
##' 
##' @param priorY2 Second parameter of the prior distribution for the annual hazard of infection, used in the independent models. If a normal distribution is chosen, it corresponds to the sd parameter. If a uniform distribution is chosen, it corresponds to the maximal value. Default = 1.
##' 
##' @param priorRho1 First parameter of the prior distribution for rho, the seroreversion rate used when seroreversion=1. If a normal distribution is chosen, it corresponds to the mean parameter. If a uniform distribution is chosen, it corresponds to the minimal value. If an exponential distribution is chosen, it is its parameter. Default = 0.
##' 
##' @param priorRho2 First parameter of the prior distribution for rho, the seroreversion rate used when seroreversion=1. If a normal distribution is chosen, it corresponds to the sd parameter. If a uniform distribution is chosen, it corresponds to the maximal value. Default = 1.
##' 
...
##' 
##' \item prior_distribution_alpha: The prior distribution of the alpha parameter used in the outbreaks models. "uniform" or "normal" or "exponential".  Default = "normal".
##' 
##' \item prior_distribution_T: The prior distribution of the T parameter used in the outbreaks models and the piecewise constant model. "uniform" or "normal" or "exponential".  Default = "normal".
##' 
##' \item prior_distribution_constant_foi: The prior distribution of the constant FOI parameter used in the constant and piecewise constant models. "uniform" or "normal" or "exponential".  Default = "normal".
##' 
##' \item prior_distribution_independent_foi: The prior distribution of the annual FOI parameter used in the independent model. "uniform" or "normal" or "exponential".  Default = "normal".
##' 
##' \item prior_distribution_rho: The prior distribution of the seroreversion parameter. "uniform" or "normal" or "exponential".  Default = "normal".
##' }
##'
##'
##' @examples
...
FOImodel <- function(type = 'constant',
                     ...
                     priorRho2 = 1,
                     cat_lambda = 1,
                     prior_distribution_alpha = "normal", # "uniform" or "normal" or "exponential"
                     prior_distribution_T = "normal",# "uniform" or "normal" or "exponential"
                     prior_distribution_constant_foi = "normal",# "uniform" or "normal"or "exponential"
                     prior_distribution_independent_foi = "normal",# "uniform" or "normal" or "exponential"
                     prior_distribution_rho = "normal",# "uniform" or "normal" or "exponential"
                     ...) {
