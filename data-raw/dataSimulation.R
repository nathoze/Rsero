...
devtools::use_data(one_peak_simulation, overwrite = TRUE)

two_peaks_simulation =  Rsero::simulate_SeroData(epidemic_years = c(1980,2000), foi =c(0.3,0.2) ) 
devtools::use_data(two_peaks_simulation, overwrite = TRUE)
...
devtools::use_data(intervention_seroreversion_simulation, overwrite = TRUE)

constant_seroreversion_simulation =  Rsero::simulate_SeroData(epidemic_years = seq(1940,2009), foi =rep(0.1,70),rho = 0.01)
devtools::use_data(constant_seroreversion_simulation, overwrite = TRUE)
...
devtools::use_data(intervention_seroreversion_two_surveys_simulation, overwrite = TRUE)

two_peaks_background_simulation =  Rsero::simulate_SeroData(epidemic_years = c(1980,2000), foi =c(0.2,0.1),pb = 0.05)
devtools::use_data(two_peaks_background_simulation, overwrite = TRUE)
